...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Appointment appointment1 = new Appointment(patient1, new Date(), "Cardiology", "Dr. Smith", "Centro de Saude Delta",  LocalTime.now(), 100.0);
        Appointment appointment2 = new Appointment(patient2, new Date(), "Dermatology", "Dr. Johnson", "USF Gama",  LocalTime.now(), 150.0);
